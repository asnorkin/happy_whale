...
from pipeline.swin.build import build_model
from pipeline.swin.swin_config import get_config


def parse_option():
    parser = argparse.ArgumentParser('Swin Transformer training and evaluation script', add_help=False)
    parser.add_argument('--cfg', type=str, metavar="FILE", help='path to config file',
                        default="pipeline/swin/configs/swin_base_patch4_window8_512_22kto1k_finetune_mine.yaml")
    parser.add_argument(
        "--opts",
    ...
    parser.add_argument('--pretrained',
                        default="swin_base_patch4_window12_384_22k.pth",
...
def load_pretrained(config, model):
    ...
    if (Nc1 != Nc2):
        if Nc1 == 21841 and Nc2 == 1000:
            ...
            map22kto1k_path = f'pipeline/swin/data/map22kto1k.txt'
